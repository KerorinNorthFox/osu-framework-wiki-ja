...
In Visual Studio or Rider, simply set the project type to "Windows Application" when creating a new solution. You can verify whether or not you have succeeded by opening the .csproj file generated by the solution in your preferred editor and checking that the `<OutputType>WinExe</OutputType>` tag exists.
